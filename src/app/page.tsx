      ...
      <section className="mt-16 grid gap-12 lg:grid-cols-2 lg:items-start">
        <div>
          ...
          <p className="mt-4 text-lg text-zinc-600">
            Бесплатно снимаем одну страницу и показываем копию 1:1. После оплаты вы получаете ZIP
            и инструкцию для Beget / Timeweb / VPS. Редактируете тексты и формы сами.
          </p>
