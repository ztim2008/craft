...
Читать вместе с ADR-0027, 0029, 0030, 0031, 0032, 0034. Puck сайт не рендерит.
...
- Действие клика у кнопок и пунктов меню: страница / **попап** / якорь / внешняя / tel / mailto / файл
- Попап-формы — `section.cli-popup` в аутлайне страницы, не отдельная вкладка. Клик по кнопке или пункту аутлайна открывает окно (`class="show"`), как у Крафтума. Правка полей — внутри открытого окна или в инспекторе.
